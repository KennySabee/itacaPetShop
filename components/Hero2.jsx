            ...
            <div className="relative px-6 py-32 sm:py-40 lg:px-8 lg:py-56 lg:pr-0">
              <div className="mx-auto max-w-2xl lg:mx-0 lg:max-w-xl">
                <div className="hidden sm:mb-10 sm:flex">
                  ...
                  Descubre nuestra exclusiva gama de muebles.{" "}
                    <Link href="/#caracteristicas" className="whitespace-nowrap font-semibold text-indigo-600">
              ...
              mimar a tus adoradas mascotas.
                ...
                <div className="mt-10 flex items-center gap-x-6">
                  ...
                  <Link href="/#dimensiones" className="text-sm font-semibold leading-6 text-gray-900">
